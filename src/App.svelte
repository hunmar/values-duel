<script>
  ...
  import DesignSystemDemo from './lib/ui/DesignSystemDemo.svelte';
...
<div class="app-container">
  <div class="app-controls">
    ...
    <button
      class="control-button design-system-button"
      on:click={() => appState.update(state => ({...state, currentState: APP_STATES.DESIGN_SYSTEM}))}
      aria-label="Design System Demo"
  ...
  <main>
    ...
    {:else if currentAppState === APP_STATES.DESIGN_SYSTEM}
      <div
        in:fly={getTransitionProps()}
        out:fade={{ duration: 300, easing: cubicOut }}
        class="screen-container"
